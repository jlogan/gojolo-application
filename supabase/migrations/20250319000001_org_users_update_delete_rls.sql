...
DROP POLICY IF EXISTS "org_users_update_org_admin" ON public.organization_users;
...
DROP POLICY IF EXISTS "org_users_delete_org_admin" ON public.organization_users;
