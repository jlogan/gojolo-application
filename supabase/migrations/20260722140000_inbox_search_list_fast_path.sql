-- Inbox list perf: fast paginated path when p_query is empty/null (no message EXISTS, no search joins).
-- Non-empty p_query keeps full search behavior from prior migrations.
